...
import app.mochamadahya.angleres.activity.CommentActivity
import app.mochamadahya.angleres.activity.DetailActivity
...
//
        holder.itemView.setOnClickListener {
            val bundle = Bundle()
            bundle.putString("userid", firebaseUser?.uid)
