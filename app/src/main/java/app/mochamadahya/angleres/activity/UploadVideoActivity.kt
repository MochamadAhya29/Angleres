...
class UploadVideoActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == pick_video || resultCode == RESULT_OK || data != null || data?.data != null) {
            ...
            pickVideoFabUpload.visibility = View.GONE
        }
    ...
    private fun uploadImage() {
        when {
            ...
            TextUtils.isEmpty(desk_post.text.toString()) -> Toast.makeText(
                ...
                progressDialog.setMessage("Sedang Mengupload Video...")
                progressDialog.show()

                val fileRef = storagePostPicture!!.child(System.currentTimeMillis().toString() + ".mp4")
