...
import kotlinx.android.synthetic.main.activity_maps_danau.*
import kotlinx.android.synthetic.main.activity_maps_kolam.*

class MapsKolam : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_maps_kolam)
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        val mapFragment = supportFragmentManager
            .findFragmentById(R.id.map_kolam) as SupportMapFragment
        mapFragment.getMapAsync(this)

        firebaseUser = FirebaseAuth.getInstance().currentUser

        img_akun_maps_kolam.setOnClickListener {
            startActivity(Intent(this, ProfileActivity::class.java))
        }
        maps_kolam.setOnClickListener {
        ...
        userRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                if (p0 != null){
                    ...
                    Glide.with(this@MapsKolam)
                        .load(user!!.photoUrl)
                        .into(img_akun_maps_kolam)
                }
            }
