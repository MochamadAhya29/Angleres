...
import kotlinx.android.synthetic.main.activity_maps_laut.*

class MapsLaut : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_maps_laut)
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        val mapFragment = supportFragmentManager
            .findFragmentById(R.id.map_laut) as SupportMapFragment
        mapFragment.getMapAsync(this)

        firebaseUser = FirebaseAuth.getInstance().currentUser

        img_akun_maps_laut.setOnClickListener {
            startActivity(Intent(this, ProfileActivity::class.java))
        }
        maps_laut.setOnClickListener {
        ...
        userRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                if (p0 != null){
                    ...
                    Glide.with(this@MapsLaut)
                        .load(user!!.photoUrl)
                        .into(img_akun_maps_laut)
                }
            }
